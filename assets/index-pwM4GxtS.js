...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>$.jsxs("div",{className:"CommentInfo",children:[$.jsxs("div",{className:"CommentInfo__title",children:[$.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",$.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),$.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({user:e})=>$.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Tc=({post:e})=>$.jsxs("div",{className:"PostInfo",children:[$.jsxs("div",{className:"PostInfo__header",children:[$.jsx("h3",{className:"PostInfo__title",children:e.title}),$.jsxs("p",{children:[" Posted by ",$.jsx(Lc,{user:e.user})]})]}),$.jsx("p",{className:"PostInfo__body",children:e.body}),$.jsx("hr",{}),e.comments&&e.comments.length>0?$.jsx(Pc,{comments:e.comments}):$.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]});function Mc({posts:e}){return $.jsx("div",{children:e.map(t=>$.jsx(Tc,{post:t},t.id))})}const Rc=e=>Nc.find(t=>t.id===e)||null,Dc=e=>zc.filter(t=>t.postId===e),jc=Cc.map(e=>({...e,user:Rc(e.userId),comments:Dc(e.id)})),Oc=()=>$.jsxs("section",{className:"App",children:[$.jsx("h1",{className:"App__title",children:"Static list of posts"}),$.jsx(Mc,{posts:jc})]});em(document.getElementById("root")).render($.jsx(Oc,{}));
